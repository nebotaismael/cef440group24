...
# Global detector backend setting - shared across modules
...
# Initialize MediaPipe components (shared across modules)
...
def check_liveness(face_image):
    ...
    try:
        ...
        emotion_score = analyze_emotion()
        
        # Run landmark analysis
        ear_score, symmetry_score = analyze_landmarks()
        
        # Run demographics analysis
        age_confidence = analyze_demographics()
        
        # Run texture analysis
        texture_score = analyze_texture()
