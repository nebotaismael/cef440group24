...
class AppColors {
  ...
  static const Color darkSurface = Color(0xFF1E1E1E); // Elevated surface in dark mode
  static const Color darkSurfaceVariant = Color(0xFF2D2D2D); // Higher elevation surface
  static const Color darkCard = Color(0xFF252525); // Card background in dark mode

  // Dark Mode Text Colors
  static const Color darkTextPrimary = Color(0xFFE1E1E1); // High emphasis text
  static const Color darkTextSecondary = Color(0xFFB3B3B3); // Medium emphasis text
  static const Color darkTextHint = Color(0xFF8A8A8A); // Low emphasis text

  // Dark Mode Primary Colors (slightly adjusted for better dark contrast)
  static const Color darkPrimary = Color(0xFF4196F9); // Brighter blue for dark mode
  static const Color darkPrimaryLight = Color(0xFF6BB6FF); // Even brighter for accents
  static const Color darkSecondary = Color(0xFF3DC997); // Brighter green for dark mode

  // Dark Mode Borders and Dividers
  static const Color darkBorder = Color(0xFF3A3A3A); // Border color for dark mode
  static const Color darkDivider = Color(0xFF2F2F2F); // Divider color for dark mode
}
