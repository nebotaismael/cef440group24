...
class _CourseManagementScreenState extends ConsumerState<CourseManagementScreen> {
  ...
  Widget _buildCourseList(List<Map<String, dynamic>> courses, AsyncValue<List<Map<String, String>>> instructorsProvider) {
  ...
  Widget _buildCourseCard(Map<String, dynamic> course, AsyncValue<List<Map<String, String>>> instructorsProvider) {
    return Card(
  ...
  void _handleCourseAction(String action, Map<String, dynamic> course, AsyncValue<List<Map<String, String>>> instructorsProvider) {
    switch (action) {
      case 'edit':
  ...
  void _showEditCourseDialog(BuildContext context, Map<String, dynamic> courseData, AsyncValue<List<Map<String, String>>> instructorsProvider) {
    showDialog(
      context: context,
      builder: (context) => _CourseFormDialog(
        title: 'Edit Course',
...
class _CourseFormDialog extends StatefulWidget {
  ...
  final AsyncValue<List<Map<String, String>>> instructorsProvider;
